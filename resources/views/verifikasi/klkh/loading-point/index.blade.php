@include('layout.head', ['title' => 'Verifikasi KLKH Loading Point'])
        ...
        <div class="page-header">
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Verifikasi KLKH</a></li>
                        ...
                        <div class="mb-3 row d-flex align-items-center">
                            ...
                            @if (Auth::user()->role != 'FOREMAN')
                                <div class="col-sm-12 col-md-2 mb-2 text-md-end">
                                    <a href="{{ route('verifikasi.klkh.loadingpoint.all') }}" data-bs-toggle="modal" data-bs-target="#verifiedAll"><span class="badge bg-success" style="font-size:14px"> Verifikasi Semua</span></a>
                                </div>
                                @include('verifikasi.klkh.loading-point.modal.verifiedall')
                            @endif
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($loading as $item)
                                        <tr>
                                            ...
                                            @endif
                                            {{-- <td>
                                                <a href=""><span class="badge bg-success">Verifikasi</span></a>
                                                <a href=""><span class="badge bg-danger">Batal Verifikasi</span></a>
                                            </td> --}}
                                            <td>

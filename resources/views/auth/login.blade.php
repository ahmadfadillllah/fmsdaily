                            ...
                            <div class="col-6">
                                <div class="d-grid"><button class="preset-btn btn-img btn active" data-value="true"
                                        ...
                                        title="Caption Show"><img
                                            src="{{ asset('dashboard/assets') }}/images/customizer/caption-on.svg"
                            ...
                            <div class="row theme-color theme-direction">
                                <div class="col-6">
                                    <div class="d-grid"><button class="preset-btn btn-img btn active" data-value="false"
                                            ...
                                            title="LTR"><img
                                                src="{{ asset('dashboard/assets') }}/images/customizer/ltr.svg"
                                                alt="img" class="img-fluid"></button></div>
                                </div>
                                <div class="col-6">
                                    <div class="d-grid"><button class="preset-btn btn-img btn" data-value="true"
                                            ...
                                            title="RTL"><img
                                                src="{{ asset('dashboard/assets') }}/images/customizer/rtl.svg"
                                                alt="img" class="img-fluid"></button></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-6">
                                    <div class="d-grid"><button class="preset-btn btn-img btn active" data-value="false"
                                            ...
                                            title="Full Width"><img
                                                src="{{ asset('dashboard/assets') }}/images/customizer/full.svg"
                                                alt="img" class="img-fluid"></button></div>
                                </div>
                                <div class="col-6">
                                    <div class="d-grid"><button class="preset-btn btn-img btn" data-value="true"
                                            ...
                                            title="Fixed Width"><img
                                                src="{{ asset('dashboard/assets') }}/images/customizer/fixed.svg"
                                                alt="img" class="img-fluid"></button></div>
                                </div>
                            </div>
                        </div>

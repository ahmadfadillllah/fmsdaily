                            ...
                            <table id="cbtn-selectors" class="table table-striped table-hover table-bordered nowrap">
                                ...
                                <tbody>
                                    @foreach ($data as $dt)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">{{ $dt->RIT_LAST3HOUR }}</td>
                                    ...
                                    @php
                                        ...
                                        $totalPayloadLess85 += $dt->PAYLOAD_LESS85;
                                        $totalPayload95100 += $dt->PAYLOAD_95100;
                                        $totalPayloadMore110 += $dt->PAYLOAD_MORE110;
                                        $totalRitAvgLast3Hour += $dt->RITAVG_LAST3HOUR;
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">{{ $totalRitLast3Hour }}</td>
